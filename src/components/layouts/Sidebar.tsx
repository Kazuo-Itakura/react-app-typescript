export default function Sidebar() {
    ...
    <div>
      ...
      <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 mt-28 bg-main text-white h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
